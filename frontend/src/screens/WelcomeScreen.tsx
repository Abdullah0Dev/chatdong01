    ...
    <ImageBackground className="h-full  w-full" source={images.WelcomeBG}>
      <View className='px-5'>
        ...
        <Text className="text-white font-bold text-4xl">
          It's easy talking to your friend with Chatdong
        </Text>
        <Text className="text-black-200 text-lg mt-5 mb-4">
          Call Your Friend Simply And Simple With Chatdong
        </Text>
        <TouchableOpacity  
          onPress={() => navigation.replace('SignIn')} // to make the user and able to chat
